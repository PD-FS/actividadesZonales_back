...
class NeighborhoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create neighborhood" do
    assert_difference('Neighborhood.count') do
      post neighborhoods_url, params: { neighborhood: { code: @neighborhood.code, district_area_id: @neighborhood.district_area_id, latitude: @neighborhood.latitude, longitude: @neighborhood.longitude, name: @neighborhood.name, shape: @neighborhood.shape, upz_id: @neighborhood.upz_id } }
    end
  ...
  test "should update neighborhood" do
    patch neighborhood_url(@neighborhood), params: { neighborhood: { code: @neighborhood.code, district_area_id: @neighborhood.district_area_id, latitude: @neighborhood.latitude, longitude: @neighborhood.longitude, name: @neighborhood.name, shape: @neighborhood.shape, upz_id: @neighborhood.upz_id } }
